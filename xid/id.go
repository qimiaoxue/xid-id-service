...
func randInt() uint32 {
	...
	if _, err := rand.Reader.Read(b); err != nil {
		panic(fmt.Errorf("xid: cannot generte random number: %v;", err))
	}
...
// encode by unrolling the stdlib base32 algorith + removing all safe checks
func encode(dst, id []byte) {
	...
	dst[17] = encoding[(id[11]>>6)&0x1F|(id[11]<<2)&0x1F]
...
/*
id = [10101010, 01010101]
10101 01001 01010 10000
10101 01001 01010 10000
21    9
*/
...
//UnmarshalJSON implements encoding/json unmarshalter interface
...
func (id ID) Time() time.Time {
	//First 4 bytes of objtectId is 32-bit big-endian seconds from epoch.
